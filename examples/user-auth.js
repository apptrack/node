...
app.get('/', function(req, res){
	if( req.user ){
		...
		//var auth =
		res.send('<html><body><a href="/auth/apptrack">Login</a></body></html>');
	}
	res.end();
});


app.get('/auth/apptrack', apptrack.auth());

app.get('/auth/apptrack/callback', apptrack.auth({ successRedirect: '/', failureRedirect: '/'}) );
